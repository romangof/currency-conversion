...
* First, tried to get the tests done right, they are currently kind of hacky and complicated, axios seems quite hard to mock  
* I would have also liked to get a better understanding of how to manage the theme with MaterialUI  
* Also created a production server, which probably wasn't too hard but was the latest priority at the moment  
